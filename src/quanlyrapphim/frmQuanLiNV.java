...
public class frmQuanLiNV extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					frmQuanLiNV qlp = new frmQuanLiNV(null);
					qlp.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
	 ...
	 * Create the frame.
	 */
	public frmQuanLiNV(String tentaikhoan) {
        ...
        JButton btnNewButton = new JButton(new ImageIcon(frmQuanLiNV.class.getResource("/image/pngwing.com (1).png")));
